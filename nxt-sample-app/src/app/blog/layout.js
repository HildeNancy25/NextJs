...
const DashboardLayout = ({children}) => {
    return(
        ...
        <div style={{display:'flex', minHeight:'100vh'}}>
            <aside style={{background:'orange', paddingTop:'2rem', paddingRight:'1.5rem'}}>
                <ul style={{marginBottom:'0.5rem', listStyleType:'none', display:'flex', flexDirection:"column", gap:'1rem'}}>
                    ...
                    <li>
                        ...
                        <span style={{display:'block'}}>Pusrchase request</span>
                        </Link>
                    </li>
                    <li>
                        <Link href='/blog/second'>
                        <span style={{display:'block'}}>Upload receipts</span>
                        </Link>
                    </li>
                </ul>
            </aside>
